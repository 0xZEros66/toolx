...
def welcome(): # Welcome page
    ...
    if result != 'y' and result != 'n' : 
        ...
        os.system('clear')
        result1 = input(colorText('[[yellow]][ ? ] Proxy path file (If your text file is already in the \"toolx\" file, just put : \"hisname.txt\", if your txt is in the \'Proxy\' folder, type "Proxy/http(or socks4...)/....txt  : '))
        if '.txt' in result1 : 
            pass
        else : 
